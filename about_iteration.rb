...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # The first argument is the initial value of the first variable 
    # in the pipes.  Then the operation is carried out and the first arg
    # is incrememnted the return value and the second arg is incrememnted 
    # by the various items in the hash.  The first is returned.
  end
