--------------NOTE--------------
My progress on the Ruby Koans, set really cool set of excersizes for learning about the Ruby langauge.  I pushed them to here so I'd have an easy way to work on them.  The the readme for the Koans you can find below, if you're interested.
-------------ENDNOTE------------
