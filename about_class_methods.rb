...
class AboutClassMethods < Neo::Koan
  ...
  # The equivilent of a Static method, I think?
  # The CLASS is an object, so you can define a method on it
  # This is done outside the class scope?
  def Dog2.wag
    :class_level_wag
  end
  ...
  # Ok that answers the earlier question about this
  ...
  # Ok, not really following that.  I think it referenced the instance
  ...
  class Dog
    ...
    # Because self in this case just means Dog
  end
  ...
  # 
  # I would use the second method when I wanted to write a bunch of class methods 
  # at one time, or if the class was only going to be used statically, like Math
